...
import { State as mailAddressState } from './state';
import mailAddressEffects from './effects';
export declare const initialSagas: {
    mailAddress: typeof mailAddressEffects;
};
export declare const initialStates: {
    mailAddress: mailAddressState;
};
export declare const sagas: (typeof mailAddressEffects)[];
export type States = {
    mailAddress: mailAddressState;
};
export type StateName = 'mailAddress';
export declare const StateNames: {
    [prop: string]: StateName;
};
export declare const reducers: {
    mailAddress: import("immer-reducer").ImmerReducerFunction<typeof import("./state").mailAddressState>;
};
