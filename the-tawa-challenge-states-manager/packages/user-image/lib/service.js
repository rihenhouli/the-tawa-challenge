...
exports.restoreData = exports.deleteData = exports.fetchListByUser = exports.fetchList = exports.fetchData = exports.updateData = exports.downloadData = exports.uploadData = void 0;
var axios_1 = __importDefault(require("axios"));
var utils_1 = require("@rihenhouli/ttcsm_common/lib/utils");
var USER_IMG_URL = utils_1.TTCS_URL + "user-image";
/*
API call for uploading a new
*/
function uploadData(userImage) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("upload user image:", userImage);
                    return [4 /*yield*/, axios_1.default.post(USER_IMG_URL + "/upload", userImage)];
...
function downloadData(filename) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(USER_IMG_URL + "/download/".concat(filename))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post(USER_IMG_URL + "/update/".concat(image._id), newUserImage)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function fetchData(_id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(USER_IMG_URL + "/".concat(_id))];
                case 1:
                    userImage = (_a.sent()).data;
                    console.log("fetchData :", userImage);
                    return [2 /*return*/, userImage];
            }
        });
    });
}
...
function fetchList() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(USER_IMG_URL + "/list")];
                case 1:
                    list = (_a.sent()).data;
...
*/
function fetchListByUser(user) {
    return __awaiter(this, void 0, void 0, function () {
        var list;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(USER_IMG_URL + "/user/".concat(user))];
                case 1:
                    list = (_a.sent()).data;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post(USER_IMG_URL + "/delete/".concat(_id), deleted)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post(USER_IMG_URL + "/restore/".concat(_id), restored)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
