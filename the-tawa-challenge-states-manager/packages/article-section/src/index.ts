...
import {
    initialState as articleSectionInitialState,
    articleSectionReducerFunction as articleSectionReducerFunction,
...
export const initialSagas = {
    articleSection: articleSectionEffects
}

export const initialStates = {
    articleSection: articleSectionInitialState
}
...
export const StateNames: { [prop: string]: StateName } = {
    articleSectionStateName: 'articleSection'
}
