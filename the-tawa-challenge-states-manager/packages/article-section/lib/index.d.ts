...
import { State as articleSectionState } from './state';
import articleSectionEffects from './effects';
export declare const initialSagas: {
    articleSection: typeof articleSectionEffects;
};
export declare const initialStates: {
    articleSection: articleSectionState;
};
export declare const sagas: (typeof articleSectionEffects)[];
export type States = {
    articleSection: articleSectionState;
};
export type StateName = 'articleSection';
export declare const StateNames: {
    [prop: string]: StateName;
};
export declare const reducers: {
    articleSection: import("immer-reducer").ImmerReducerFunction<typeof import("./state").articleSectionState>;
};
