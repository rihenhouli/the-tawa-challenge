...
import { State as userPasswordState } from './state';
import userPasswordEffects from './effects';
export declare const initialSagas: {
    userPassword: typeof userPasswordEffects;
};
export declare const initialStates: {
    userPassword: userPasswordState;
};
export declare const sagas: (typeof userPasswordEffects)[];
export type States = {
    userPassword: userPasswordState;
};
...
export declare const reducers: {
    userPassword: import("immer-reducer").ImmerReducerFunction<typeof import("./state").userPasswordState>;
};
