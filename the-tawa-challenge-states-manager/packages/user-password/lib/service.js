...
exports.resetData = exports.fetchListByUser = exports.fetchList = exports.addData = void 0;
var axios_1 = __importDefault(require("axios"));
var utils_1 = require("@rihenhouli/ttcsm_common/lib/utils");
var USER_PASSWORD_URL = utils_1.TTCS_URL + "user-password";
/*
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post(USER_PASSWORD_URL + "/add", newUserPassword)];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post(USER_PASSWORD_URL + "/reset", resetObject)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function fetchList() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(USER_PASSWORD_URL + "/list")];
                case 1:
                    list = (_a.sent()).data;
...
function fetchListByUser(user) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(USER_PASSWORD_URL + "/user/".concat(user))];
                case 1:
                    list = (_a.sent()).data;
